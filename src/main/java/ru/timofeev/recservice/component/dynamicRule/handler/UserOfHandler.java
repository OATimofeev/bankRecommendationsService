...
public class UserOfHandler implements RuleConditionHandler {
    ...
    public boolean check(UUID userId, List<String> arguments) {
        ...
        RuleParseUtil.checkArgsSize(arguments, 1, QueryType.USER_OF.toString());
        ProductTypeEnum productType = RuleParseUtil.parseProductType(arguments.getFirst());

        return transactionsRepository.hasProductType(userId, productType);
    }
}
